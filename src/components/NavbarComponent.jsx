    ...
    <div className="bg-white w-full shadow">
      ...
      >
        <Navbar.Brand as={Link} to={"/"}>
          <span className="cursor-pointer self-center whitespace-nowrap text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold dark:text-white">
            J
            <span className="text-[#72B261] font-bold text-3xl sm:text-4xl md:text-5xl lg:text-5xl">
              o
            </span>
            bNest
          </span>
          ...
          {navbarList.map((list, index) => {
            return (
              <Navbar.Link
                ...
                to={list.url}
                className={`${
                  list.active ? "text-[#72B261] font-bold" : "text-gray-700"
                }  navbar-link`}
