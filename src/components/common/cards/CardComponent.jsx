    ...
    <div className="w-full h-full">
      <Card className="w-full h-full">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h5 className="mt-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">
              {company_name}
            </h5>
        ...
        <div className="my-3">
          <h5 className="text-lg font-semibold text-[#72B261] dark:text-white">
            {title}
          </h5>
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <FaClock className="text-[#72B261]" />
              <span className="text-base">{job_type}</span>
            </div>
            <div className="flex items-center gap-2">
              <FaSearchDollar className="text-[#72B261]" />
          ...
          <button
            ...
            className="rounded-lg bg-[#72B261] px-4 py-2 text-center text-sm font-medium text-white hover:bg-[#83B348] focus:outline-none focus:ring-2 focus:ring-[#72B261] dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
