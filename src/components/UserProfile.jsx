...
export default function UserProfile() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto bg-white rounded-lg shadow-md px-4 py-4">
      ...
      {messages.success && (
        <p className="text-center text-[#83B348]">{messages.success}</p>
      )}

      <div className="flex flex-col items-center mb-6">
        <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-[#72B261] mb-4">
          <img
        ...
        <div className="relative bg-slate-200 p-1 px-2 rounded-md">
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-3/4 lg:w-2/3">
          <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4" key={key}>
                    ...
                    {key === "dob" ? (
                      <input
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#72B261]"
                      />
                    ) : key === "bio" ? (
                      <textarea
                        name={key}
            ...
            <button
              type="submit"
              className="w-full bg-[#72B261] text-white p-3 mt-3 rounded-lg hover:bg-[#83B348] transition duration-200"
            >
              Update Profile
            </button>
          </form>
