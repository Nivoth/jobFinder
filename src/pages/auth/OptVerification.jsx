          ...
          <Form className="max-w-sm w-full border border-gray-200 rounded-lg shadow-md p-6 bg-white">
            ...
            <div className="flex justify-center mb-4">
              <Field
                ...
                type="text"
                maxLength="6"
                className="w-full h-12 border border-gray-300 rounded-md text-center text-xl text-gray-900 focus:ring-[#72B261] focus:border-[#72B261] outline-none"
              />
            </div>
            <ErrorMessage
              name="otp"
            ...
            <button
              ...
              className={`w-full py-2 px-4 text-sm font-medium text-white rounded-md ${
                isSubmitting || !isValid
                  ? "bg-[#72B261] cursor-not-allowed"
                  : "bg-[#72B261] hover:bg-[#83B348]"
              }`}
            ...
            <div className="text-center mt-4">
              ...
              <button
                ...
                disabled={resending}
                className={`text-[#72B261] font-medium ${
