        ...
        {({ isSubmitting }) => (
          <Form className="max-w-md w-full border border-gray-300 rounded-2xl p-8 mx-4">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-sans font-bold text-black">J<span className="text-[#72B261]">o</span>bNest</h1> {/* Changed title */}
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Field
                  name="email"
                  type="text"
                  className="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md focus:ring-[#72B261] focus:border-[#83B348]"
              ...
              <button
                ...
                className={`w-full py-3 px-4 text-sm tracking-wider font-semibold rounded-md text-white ${
                  isSubmitting
                    ...
                    : "bg-[#72B261] hover:bg-[#83B348]" // Updated colors
                }`}
            ...
            <p className="text-gray-800 text-sm mt-6 text-center">
              ...
              <Link
                to="/register"
                className="text-[#72B261] font-semibold hover:underline ml-1"
              >
                Register here
              </Link>
            </p>
