    ...
    <div className="max-w-[1440px] mx-auto xl:px-[100px]">
      <form className="">
        ...
        <div className="relative">
          ...
          <input
            type="search"
            className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#72B261] focus:border-[#83B348] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Search..."
            required
      ...
      <div className="grid lg:grid-cols-3 gap-1 border p-4 rounded-sm">
        ...
        <div className="">
          <select
            ...
            className=" text-base 2xl:text-lg text-sky-900 border border-[#72B261] focus:ring-[#72B261] focus:border-[#83B348] rounded-md sm:w-[100%] min-[350px]:w-[100%] w-full"
          >
