      ...
      <div className="2xl:px-[100px] max-w-[1440px] grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto bg-white font-[sans-serif]">
        <div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <span>#12, Street 2001, Khan Toul Kork, Phnom Penh</span>
          </div>
          <div className="flex items-center space-x-2">
            <FaPhoneAlt className="text-red-600" />
            <span>+855 96 538 8 074</span>
          </div>
          <div className="flex items-center space-x-2">
            <FaEnvelope className="text-red-600" />
            <span>nivothsoun533@gmail.com</span>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <form className="ml-auto space-y-4">
          <input
            type="text"
            placeholder="Name"
            className="w-full rounded-md py-3 px-4  text-gray-800 text-sm outline-[#83B348] focus:ring-[#72B261] focus:border-[#83B348] focus:bg-transparent "
          />
          <input
            type="email"
            placeholder="Email"
          ...
          <textarea
            placeholder="Message"
            rows="6"
            className="w-full rounded-md px-4  text-gray-800 text-sm pt-3 outline-[#83B348] focus:ring-[#72B261] focus:border-[#83B348]  focus:bg-transparent"
          ></textarea>
          <button
            type="button"
            className="text-white bg-[#72B261] hover:bg-[#83B348] tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6"
          >
            Send
          </button>
        </form>
